...
- **Key Functions / Classes**:
  - [`SqlRunner`](file:///C:/Users/shubh/OneDrive/Desktop/interns/core/provisioning/ingestion_run.py#L54-L59): Protocol (`execute(sql)`) so tests record statements and never reach a warehouse.
